...
class StockEnvTrade(gym.Env):
    ...
    def __init__(self, df, turbulence_threshold, initial=True, previous_state=None, model_name='', iteration='', render_mode=None):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.day = 0
        self.data = self.df.loc[self.df['datadate'] == self.df.datadate.unique()[self.day]]
        ...
        if self.initial:
            ...
            print("previous_total_asset:{}".format(previous_total_asset))
        ...
        return self.state, {}  # Return state directly instead of using _get_observation
